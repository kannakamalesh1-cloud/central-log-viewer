            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-6">
              ...
              <div className="relative">
                <input 
                  ...
                  autoCorrect="off"
                  spellCheck="false"
                  className={`w-full bg-[#080808]/80 border ${error ? 'border-red-500/30' : 'border-white/5'} rounded-2xl p-5 text-white outline-none focus:border-cyan-500/50 transition-all font-mono`} 
                />
              </div>
              <div className="relative">
                <input 
                  ...
                  className={`w-full bg-[#080808]/80 border ${error ? 'border-red-500/30' : 'border-white/5'} rounded-2xl p-5 text-white outline-none focus:border-purple-500/50 transition-all font-mono`} 
                />
                <button 
                   type="button" 
